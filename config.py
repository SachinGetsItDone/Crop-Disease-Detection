...
# ── App ─────────────────────────────────────────────────────────────────────────
APP_TITLE = "KrishiMitra AI — Detect"
APP_ICON  = "🌿"

# ── Symptom quick-chips shown below the textarea ────────────────────────────────
SYMPTOM_CHIPS = [
    "yellow spots on leaves",
    "brown lesions with dark border",
    "white powdery coating",
    "orange rust pustules",
    "curling mosaic leaves",
]

# ── Default class names (used if classes.txt is missing) ───────────────────────
DEFAULT_CLASS_NAMES = [
    "Apple___Apple_scab",
    "Apple___Black_rot",
